...
export class ReviewService {
  ...
  getByRecipeId(recipeId: number): Observable<any> {
  ...
  checkIfPreviouslyReviewed(userId: number, recipeId: number): Observable<any> {
    return this.http.get<any>(this.baseUrl + "/reviewed/" + userId + "/" + recipeId);
  }
}
