...
class FavouriteControllerImplTest {
    ...
    @Test
    void getAllFavouriteRecipesByUserId() throws Exception {
        ...
        assertTrue(result.getResponse().getContentAsString().contains("ingredients"));
        assertTrue(result.getResponse().getContentAsString().contains("method"));
        assertTrue(result.getResponse().getContentAsString().contains("diets"));
        assertTrue(result.getResponse().getContentAsString().contains("name"));
        assertFalse(result.getResponse().getContentAsString().contains("\"id\":3"));
